<section class="flex flex-col md:flex-row md:items-start justify-between gap-6">
    ...
    <div class="shrink-0 mt-2 md:mt-0">
        <button
            ...
            class="inline-flex items-center px-4 py-2.5 bg-white border border-red-200 rounded-xl font-semibold text-sm text-red-600 hover:bg-red-50 hover:border-red-300 active:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 transition ease-in-out duration-150 shadow-sm"
        >
