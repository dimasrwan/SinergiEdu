<x-layouts.app>
    ...
    <div class="w-full">
        ...
        <div class="mb-6 flex flex-col items-start gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-900">Tambah Semester</h1>
                <p class="mt-1 text-sm text-slate-500">Mendaftarkan semester pada tahun ajaran akademik.</p>
            </div>
        </div>
        ...
        <x-card padding="none" class="overflow-hidden">
            <form action="{{ route('admin.semesters.store') }}" method="POST">
                ...
                <div class="p-6 md:p-8 space-y-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="name" name="name" class="block w-full pl-3 pr-10 py-2 border border-slate-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent sm:text-sm" required>
                ...
                <div class="px-6 py-5 border-t border-slate-100 bg-slate-50/50 flex flex-col-reverse sm:flex-row items-center justify-end gap-3 sm:gap-4">
                    ...
                    <x-button variant="primary" type="submit" class="w-full sm:w-auto justify-center">Simpan Semester</x-button>
                </div>
            </form>
        </x-card>
    </div>
