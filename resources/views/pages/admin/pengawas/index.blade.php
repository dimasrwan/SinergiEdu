                                ...
                                <td class="px-6 py-4 text-right">
                                    <div x-data="{ menuOpen: false }" class="relative inline-block text-left">
                                        ...
                                        <div x-show="menuOpen" x-transition class="absolute right-0 z-10 mt-1 w-40 origin-top-right rounded-xl bg-white shadow-lg ring-1 ring-slate-900/5 focus:outline-none py-1" style="display: none;">
                                            <a href="{{ route('admin.pengawas.show', $item) }}" class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-primary transition-colors">Lihat Detail</a>
                                            <a href="{{ route('admin.pengawas.edit', $item) }}" class="block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-accent transition-colors">Edit Data</a>
                                            <div class="my-1 border-t border-slate-100"></div>
                                            <button type="button" x-on:click="$dispatch('open-modal', 'delete-pengawas-{{ $item->id }}'); menuOpen = false" class="block w-full text-left px-4 py-2 text-sm text-danger hover:bg-red-50 transition-colors">
                                                Hapus
                                            </button>
                                        </div>
                                    </div>
