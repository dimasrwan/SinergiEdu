<x-layouts.app>
    ...
    <div class="w-full">
        ...
        <div class="mb-6 flex flex-col items-start gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-900">Tambah Mata Pelajaran</h1>
                <p class="mt-1 text-sm text-slate-500">Mendaftarkan data mata pelajaran baru ke dalam master sistem.</p>
            </div>
        </div>
        ...
        <x-card padding="none" class="overflow-hidden">
            <form action="{{ route('admin.subjects.store') }}" method="POST">
                ...
                <div class="p-6 md:p-8 space-y-6">
                    ...
                    <div class="space-y-5">
                        <div>
                            ...
                            <x-text-input id="name" name="name" type="text" :value="old('name')" placeholder="Misal: Matematika" required class="w-full" />
                        </div>
                        ...
                        <div>
                            ...
                            <x-text-input id="code" name="code" type="text" :value="old('code')" placeholder="Misal: MAT" required class="w-full" />
                            <p class="text-[11px] text-slate-500 mt-1.5">Gunakan singkatan ringkas yang unik untuk identifikasi internal (Max 50 karakter).</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="px-6 py-5 border-t border-slate-100 bg-slate-50/50 flex flex-col-reverse sm:flex-row items-center justify-end gap-3 sm:gap-4">
                    ...
                    <x-button variant="primary" type="submit" class="w-full sm:w-auto justify-center">Simpan Mata Pelajaran</x-button>
                </div>
            </form>
        </x-card>
    </div>
