                                ...
                                <td class="py-4 px-6 text-right">
                                    <div class="flex items-center justify-end gap-2 ">
                                        ...
                                        <form action="{{ route('admin.subjects.destroy', $subject) }}" method="POST" class="inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus mata pelajaran ini?\n\nPENTING: Jika mata pelajaran ini telah digunakan oleh modul lain (tugas, materi, penilaian, penugasan guru), sistem akan memblokir penghapusan.');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="Hapus" aria-label="Hapus mata pelajaran">
