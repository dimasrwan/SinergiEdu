<x-layouts.app>
    ...
    <div class="w-full">
        <div class="mb-6">
            ...
            <x-page-header title="Tambah Siswa Baru" description="Buat akun siswa baru, hubungkan ke kelas akademik aktif, serta tentukan orang tua/wali siswa." />
        </div>
                        ...
                        <div>
                            ...
                            <x-select id="class_id" name="class_id" required>
                                ...
                                @foreach($classes as $classItem)
                                    <option value="{{ $classItem->id }}" {{ old('class_id') == $classItem->id ? 'selected' : '' }}>{{ $classItem->name }} (Grade {{ $classItem->grade_level }})</option>
                                @endforeach
                            </x-select>
