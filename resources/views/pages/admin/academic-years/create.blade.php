<x-layouts.app>
    ...
    <div class="w-full">
        ...
        <div class="mb-6 flex flex-col items-start gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-900">Tambah Tahun Ajaran</h1>
                <p class="mt-1 text-sm text-slate-500">Mendaftarkan periode tahun ajaran baru ke dalam master data.</p>
            </div>
        </div>
        ...
        <x-card padding="none" class="overflow-hidden">
            <form action="{{ route('admin.academic-years.store') }}" method="POST">
                ...
                <div class="p-6 md:p-8 space-y-6">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <x-text-input id="year" name="year" type="text" :value="old('year')" placeholder="Contoh: 2026/2027" required class="w-full" />
                            <p class="text-[11px] text-slate-500 mt-1.5">Gunakan format yang konsisten, misal YYYY/YYYY.</p>
                        </div>
                ...
                <div class="px-6 py-5 border-t border-slate-100 bg-slate-50/50 flex flex-col-reverse sm:flex-row items-center justify-end gap-3 sm:gap-4">
                    ...
                    <x-button variant="primary" type="submit" class="w-full sm:w-auto justify-center">Simpan Tahun Ajaran</x-button>
                </div>
            </form>
        </x-card>
    </div>
