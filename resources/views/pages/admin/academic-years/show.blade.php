<x-layouts.app>
    ...
    <div class="w-full space-y-6">
        ...
        <div class="flex flex-col items-start gap-4 border-b border-slate-200 pb-5">
            <a href="{{ route('admin.academic-years.index') }}" class="inline-flex items-center text-xs sm:text-sm font-semibold text-slate-500 hover:text-slate-800 gap-1.5 transition">
            ...
            <div class="w-full flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
                <div>
                    <h1 class="text-xl sm:text-2xl font-bold tracking-tight text-slate-900">Detail Tahun Ajaran {{ $academicYear->year }}</h1>
                    <p class="mt-1 text-xs sm:text-sm text-slate-500">Informasi rekap status tahun ajaran dan daftar kelas terkait.</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <!-- Daftar Kelas (Main Content Right) -->
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr class="bg-white border-b border-slate-100">
                                        <th class="py-3.5 px-6 text-xs font-bold text-slate-400 uppercase tracking-wider w-[35%]">NAMA KELAS</th>
                                        <th class="py-3.5 px-6 text-xs font-bold text-slate-400 uppercase tracking-wider w-[20%]">TINGKAT</th>
                                        <th class="py-3.5 px-6 text-xs font-bold text-slate-400 uppercase tracking-wider w-[45%]">WALI KELAS</th>
                                    </tr>
                                </thead>
