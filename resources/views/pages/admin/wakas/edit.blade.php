<x-layouts.app>
    <x-slot:title>Edit Waka Kurikulum</x-slot:title>
    ...
    <div class="w-full">
        <div class="mb-6 flex flex-col items-start gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-900">Edit Data Waka Kurikulum</h1>
                <p class="mt-1 text-sm text-slate-500">Ubah detail profil dan kredensial akun Waka Kurikulum.</p>
            </div>
        </div>

        <x-card padding="none" class="overflow-hidden">
            <form action="{{ route('admin.wakas.update', $waka) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" :value="old('name', $waka->user->name)" placeholder="Masukkan nama lengkap Waka" required class="w-full" />
                            ...
                            <div>
                                ...
                                <x-text-input id="email" name="email" type="email" :value="old('email', $waka->user->email)" placeholder="Masukkan alamat email" required class="w-full" />
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nip" name="nip" type="text" :value="old('nip', $waka->nip)" placeholder="Kosongkan jika tidak ada" class="w-full" />
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" name="phone" type="text" :value="old('phone', $waka->phone)" placeholder="Kosongkan jika tidak ada" class="w-full" />
                            ...
                            <div>
                                ...
                                <x-textarea id="address" name="address" rows="3" placeholder="Kosongkan jika tidak ada">{{ old('address', $waka->address) }}</x-textarea>
