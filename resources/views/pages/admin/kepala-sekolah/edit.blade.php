<x-layouts.app>
    <x-slot:title>Edit Kepala Sekolah/Madrasah</x-slot:title>
    ...
    <div class="w-full">
        <div class="mb-6 flex flex-col items-start gap-4">
            ...
            <div>
                <h1 class="text-2xl font-bold tracking-tight text-slate-900">Edit Data Kepala Sekolah/Madrasah</h1>
                <p class="mt-1 text-sm text-slate-500">Ubah detail profil dan kredensial akun.</p>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" :value="old('name', $kepalaSekolah->user->name)" placeholder="Masukkan nama lengkap" required class="w-full" />
                            ...
                            <div>
                                ...
                                <x-text-input id="email" name="email" type="email" :value="old('email', $kepalaSekolah->user->email)" placeholder="Masukkan alamat email" required class="w-full" />
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="nip" name="nip" type="text" :value="old('nip', $kepalaSekolah->nip)" placeholder="Kosongkan jika tidak ada" class="w-full" />
                            ...
                            <div>
                                ...
                                <x-text-input id="phone" name="phone" type="text" :value="old('phone', $kepalaSekolah->phone)" placeholder="Kosongkan jika tidak ada" class="w-full" />
                            ...
                            <div>
                                ...
                                <x-textarea id="address" name="address" rows="3" placeholder="Kosongkan jika tidak ada">{{ old('address', $kepalaSekolah->address) }}</x-textarea>
