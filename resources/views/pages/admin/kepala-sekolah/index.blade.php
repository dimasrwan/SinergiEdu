                        ...
                        @forelse($kepalaSekolah as $index => $item)
                            <tr class="hover:bg-slate-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4 text-right">
                                        ...
                                        <button type="button" x-on:click.prevent="$dispatch('open-modal', 'delete-item-{{ $item->id }}')" class="p-1.5 text-slate-400 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="Hapus" aria-label="Hapus kepala sekolah">
