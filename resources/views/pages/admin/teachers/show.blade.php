        ...
        <div class="bg-white border border-slate-200/60 rounded-3xl p-6 md:p-8 shadow-sm space-y-8">
            ...
            <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b pb-6">
                ...
                <div class="flex items-center gap-2">
                    <button type="button" x-on:click.prevent="$dispatch('open-modal', 'add-assignment')" class="px-4 py-2.5 text-sm font-semibold text-white bg-accent hover:bg-blue-600 rounded-xl transition duration-150 inline-flex items-center gap-1.5">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <select name="semester_id" required class="block w-full py-2.5 px-3 text-sm border border-slate-300 focus:border-accent focus:ring focus:ring-accent/20 rounded-lg bg-white shadow-sm cursor-pointer">
                                                                        ...
                                                                        @foreach($semesters as $sem)
                                                                            <option value="{{ $sem->id }}" @selected($assignment->semester_id == $sem->id)>{{ $sem->academicYear->year }} - {{ $sem->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </div>
                                                            </div>
