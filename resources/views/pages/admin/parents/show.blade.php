            ...
            <div class="lg:col-span-7 space-y-6">
                <x-card padding="lg">
                    <div class="flex items-center justify-between mb-5 border-b border-slate-100 pb-3">
                        ...
                        <span class="inline-flex items-center justify-center bg-blue-50 text-primary text-xs font-bold px-2.5 py-0.5 rounded-full border border-blue-100">
                    ...
                    @if($parent->students->count() > 0)
                        <div class="space-y-4">
                            @foreach($parent->students as $student)
                                <div class="flex flex-col sm:flex-row sm:items-center justify-between p-4 bg-white border border-slate-200 shadow-sm rounded-xl hover:border-slate-300 transition-colors">
                                    <div>
                                    ...
                                    <div class="mt-2 sm:mt-0">
                                        <span class="inline-flex text-[10px] font-bold uppercase tracking-wider text-primary bg-blue-50 px-2.5 py-1 rounded-md border border-blue-100">
