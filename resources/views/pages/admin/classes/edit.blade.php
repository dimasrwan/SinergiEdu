                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-select id="education_level" 
                                          ...
                                          required 
                                          :selected="old('education_level', $class->education_level)" 
                                          :options="[
                            ...
                            <div>
                                ...
                                <x-select id="grade_level" 
                                          ...
                                          required 
                                          :selected="old('grade_level', $class->grade_level)" 
                                          :options="[
                                              ['value' => '1', 'label' => '1'],
                                              ['value' => '2', 'label' => '2'],
                                              ['value' => '3', 'label' => '3'],
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-select id="academic_year_id" 
                                          ...
                                          required 
                                          :selected="old('academic_year_id', $class->academic_year_id)" 
                            ...
                            <div>
                                ...
                                <x-select id="homeroom_teacher_id" 
                                          ...
                                          :selected="old('homeroom_teacher_id', $class->homeroom_teacher_id)" 
