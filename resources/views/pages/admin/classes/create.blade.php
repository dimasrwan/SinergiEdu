                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="name" name="name" type="text" :value="old('name')" placeholder="Misal: X IPA 1" required class="w-full" />
                                <p class="text-[11px] text-slate-500 mt-1.5">Gunakan format penamaan standar sekolah.</p>
                            </div>
