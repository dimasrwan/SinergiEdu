    ...
    <div class="w-full max-w-2xl">
        ...
        <div class="mb-6 flex flex-col items-start gap-4">
            @if(request('redirect_to') === 'teacher')
                <a href="{{ route('admin.teachers.show', $teacherAssignment->teacher_id) }}" class="inline-flex items-center text-sm font-semibold text-slate-500 hover:text-slate-800 gap-1.5 transition">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">Perbarui data konteks penugasan mengajar.</p>
            </div>
        </div>
