                ...
                <form action="{{ route('admin.teacher-assignments.index') }}" method="GET" class="flex flex-col gap-3">
                    <div class="flex flex-col md:flex-row gap-3">
                        <div class="w-full md:w-1/4 relative">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari guru, mata pelajaran, atau kelas..." class="block w-full pl-10 pr-3 py-2 text-sm border border-slate-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent">
                        </div>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse($assignments as $index => $assignment)
                            <tr class="hover:bg-slate-50/50 transition-colors group">
                                ...
                                <td class="py-4 px-6">
                                    <span class="inline-flex items-center text-xs font-semibold text-slate-700 bg-slate-100 px-2 py-0.5 rounded-md border border-slate-200">
                                ...
                                <td class="py-4 px-6 text-right">
                                    <div class="flex items-center justify-end gap-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                                        <a href="{{ route('admin.teacher-assignments.edit', $assignment) }}" class="p-1.5 text-slate-400 hover:text-accent hover:bg-blue-50 rounded-lg transition-colors" title="Edit">
