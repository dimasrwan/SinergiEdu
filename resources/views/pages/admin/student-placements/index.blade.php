                ...
                <form action="{{ route('admin.student-placements.index') }}" method="GET" class="flex flex-col gap-3">
                    <div class="flex flex-col md:flex-row gap-3">
                        <div class="w-full md:w-1/3 relative">
                            ...
                            <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama siswa atau NIS..." class="block w-full pl-10 pr-3 py-2 text-sm border border-slate-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-accent focus:border-accent">
                        </div>
                            ...
                            <tr class="hover:bg-slate-50/50 transition-colors group">
                                ...
                                <td class="py-4 px-6 text-right">
                                    <div class="flex items-center justify-end gap-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                                        <a href="{{ route('admin.student-placements.edit', $placement) }}" class="p-1.5 text-slate-400 hover:text-accent hover:bg-blue-50 rounded-lg transition-colors" title="Pindah Kelas">
