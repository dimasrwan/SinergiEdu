                ...
                @forelse($materials as $material)
                    <div class="bg-white border border-slate-200/75 rounded-2xl p-5 flex flex-col h-full shadow-sm hover:shadow-md hover:border-primary/40 transition group">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <span class="inline-flex text-[11px] font-bold text-primary uppercase tracking-wider">
                        ...
                        <h3 class="text-[17px] font-bold text-slate-900 mb-2 leading-snug group-hover:text-primary transition-colors">{{ $material->title }}</h3>
                        ...
                        <div class="mt-auto space-y-4 pt-4 border-t border-slate-100">
                            ...
                            <a href="{{ route('siswa.materials.show', $material->id) }}" class="flex items-center justify-center w-full py-2.5 bg-slate-50 hover:bg-slate-100 text-slate-700 text-sm font-bold rounded-xl border border-slate-200 transition">
                                Buka Materi &rarr;
                            </a>
                        </div>
                    </div>
