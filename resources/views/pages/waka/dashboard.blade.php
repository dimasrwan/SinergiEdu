    ...
    <div class="w-full space-y-8">
        ...
        <div class="bg-primary rounded-3xl p-8 text-white shadow-xl shadow-primary/20 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h1 class="text-3xl font-bold tracking-tight mb-2">Ikhtisar Kurikulum</h1>
                    <p class="text-indigo-200 text-sm max-w-xl">Tahun Ajaran 2026/2027 • Semester Ganjil</p>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <table class="w-full text-left border-collapse">
                                <thead>
                                    <tr class="bg-slate-50 border-b border-slate-200">
                                        ...
                                        <th class="py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">KKM</th>
                                        <th class="py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Nilai Rata-rata</th>
                                        <th class="py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Distribusi (>KKM)</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-slate-100">
                                    <tr class="hover:bg-slate-50">
                                        <td class="py-3 px-4 font-semibold text-slate-900 text-sm">Matematika Peminatan</td>
                                        <td class="py-3 px-4 text-slate-600 text-sm">75</td>
                                        <td class="py-3 px-4 text-sm font-bold text-slate-900">76.4</td>
                                        <td class="py-3 px-4">
                                            <div class="flex items-center gap-2">
                                                <div class="w-24 bg-slate-200 rounded-full h-1.5"><div class="bg-orange-500 h-1.5 rounded-full" style="width: 55%"></div></div>
                                                <span class="text-xs font-medium text-slate-600">55%</span>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr class="hover:bg-slate-50">
                                        <td class="py-3 px-4 font-semibold text-slate-900 text-sm">Fisika</td>
                                        <td class="py-3 px-4 text-slate-600 text-sm">75</td>
                                        <td class="py-3 px-4 text-sm font-bold text-slate-900">81.2</td>
                                        <td class="py-3 px-4">
                                            <div class="flex items-center gap-2">
                                    ...
                                    <tr class="hover:bg-slate-50">
                                        <td class="py-3 px-4 font-semibold text-slate-900 text-sm">Biologi</td>
                                        <td class="py-3 px-4 text-slate-600 text-sm">78</td>
                                        <td class="py-3 px-4 text-sm font-bold text-slate-900">85.0</td>
                                        <td class="py-3 px-4">
                                            <div class="flex items-center gap-2">
            ...
            <div class="col-span-1 space-y-8">
                ...
                <section>
                    ...
                    <div class="bg-white border border-red-200 rounded-2xl p-5 shadow-sm shadow-red-100/50">
                ...
                <section>
                    ...
                    <div class="space-y-3">
                        <a href="{{ route('waka.monitoring.classes') }}" class="flex items-center justify-between p-4 bg-white border border-slate-200 rounded-xl hover:border-accent hover:shadow-md transition group">
                        ...
                        <a href="{{ route('waka.monitoring.evaluations') }}" class="flex items-center justify-between p-4 bg-white border border-slate-200 rounded-xl hover:border-accent hover:shadow-md transition group">
                            <div class="flex items-center gap-3">
                                <div class="bg-slate-100 text-slate-500 p-2 rounded-lg group-hover:bg-blue-50 group-hover:text-accent transition">
