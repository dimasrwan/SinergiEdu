<x-layouts.app>
    ...
    <div class="w-full">
        <div class="mb-6">
            ...
            <x-page-header title="Tambah Tahun Ajaran Baru" description="Buat format penamaan tahun ajaran baru, seperti '2026/2027'." />
        </div>

        <x-card padding="lg">
            <form action="{{ route('waka.academic-years.store') }}" method="POST" class="space-y-6">
                @csrf

                <div>
                    <x-input-label for="year" :value="__('Tahun Ajaran')" />
                    <x-text-input id="year" name="year" type="text" :value="old('year')" placeholder="Contoh: 2026/2027" required />
                ...
                <div class="pt-4 flex justify-end gap-3">
                    ...
                    <x-button variant="primary" type="submit">Simpan Tahun Ajaran</x-button>
                </div>
            </form>
        </x-card>
    </div>
