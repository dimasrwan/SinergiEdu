                ...
                @forelse($classes as $classItem)
                    <tr>
                        ...
                        <td class="px-6 py-4 flex items-center gap-3">
                            <a href="{{ route('waka.classes.edit', $classItem) }}" class="text-xs font-semibold text-slate-600 hover:text-slate-900 transition">Edit</a>
                            
                            <div x-data class="inline-block">
                                <button type="button" x-on:click.prevent="$dispatch('open-modal', 'delete-class-{{ $classItem->id }}')" class="text-xs font-semibold text-danger hover:text-red-800 transition">Hapus</button>
