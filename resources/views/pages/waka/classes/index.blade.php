    ...
    <div class="space-y-6">
        ...
        <x-card padding="none">
            ...
            <div class="block sm:hidden divide-y divide-slate-100">
                @forelse($classes as $classItem)
                    <div class="p-4 space-y-3">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="font-bold text-slate-900 text-base">{{ $classItem->name }}</h3>
                                <p class="text-xs text-slate-500 mt-0.5">Tingkat Kelas: {{ $classItem->grade_level }}</p>
                            </div>
                        </div>
                        <div class="flex items-center justify-end gap-2 pt-2 border-t border-slate-100">
                            ...
                            <div x-data class="inline-block">
                                <button type="button" 
                                        x-on:click.prevent="$dispatch('open-modal', 'delete-class-mob-{{ $classItem->id }}')" 
                                ...
                                <x-modal name="delete-class-mob-{{ $classItem->id }}" maxWidth="sm">
                                    <div class="p-6">
                                        ...
                                        <div class="mt-6 flex justify-end gap-3">
                                            <x-button variant="secondary" x-on:click="$dispatch('close-modal', 'delete-class-mob-{{ $classItem->id }}')">Batal</x-button>
                ...
                @empty
                    <div class="p-6 text-center text-slate-400 text-sm">Belum ada data kelas.</div>
                @endforelse
            </div>
