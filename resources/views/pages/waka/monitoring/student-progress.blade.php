                ...
                <div class="space-y-6">
                    <x-card padding="sm" class="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-slate-50 border-slate-200">
                        ...
                        <div class="flex items-end gap-3 text-right">
                            <x-button variant="secondary" href="{{ route('waka.monitoring.student-progress.export', ['student_id' => $selectedStudent->id]) }}" target="_blank" class="gap-1.5 text-rose-600 hover:text-rose-700 hover:bg-rose-50 border-rose-200">
