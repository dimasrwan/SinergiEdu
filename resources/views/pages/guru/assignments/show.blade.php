                ...
                <x-card padding="lg" class="h-auto">
                    ...
                    @if($assignment->attachment_path)
                        <div class="mt-5 pt-5 border-t border-slate-100">
                            ...
                            <a href="{{ asset('storage/' . $assignment->attachment_path) }}" target="_blank" class="inline-flex items-center gap-2 p-3 w-full bg-blue-50/50 border border-blue-100 rounded-xl text-sm font-semibold text-blue-700 hover:bg-blue-100 transition">
