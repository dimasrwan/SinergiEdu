<x-layouts.app>
    <x-slot:title>Buat Tugas Baru</x-slot:title>
    ...
    <div class="w-full">
        <div class="mb-6">
            ...
            <x-page-header title="Buat Tugas Baru" description="Isi detail tugas yang akan dikerjakan oleh siswa." />
        </div>
        ...
        <x-card padding="lg">
            <form action="{{ route('guru.assignments.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div x-data="{
                    ...
                    selectedMeetingId: '{{ old('learning_meeting_id') }}',
                ...
                <div>
                    ...
                    <x-text-input id="title" name="title" type="text" :value="old('title')" required placeholder="Contoh: Latihan Soal Logaritma" />
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 border-t pt-6">
                    <div>
                        ...
                        <x-text-input id="deadline" name="deadline" type="datetime-local" :value="old('deadline')" required />
                        <x-input-error :messages="$errors->get('deadline')" class="mt-2" />
                    </div>

                    <div x-data="fileUpload('attachment')">
                        <x-input-label for="attachment" value="Lampiran Pendukung (Opsional)" />
                        <div 
                        ...
                        >
                            <div class="space-y-1 text-center">
                                ...
                                <p class="text-xs text-slate-500">Maks. 20MB. PDF, DOCX, ZIP.</p>
                            </div>
                        </div>
                ...
                <div class="pt-4 flex justify-end gap-3">
                    ...
                    <x-button variant="primary" type="submit">Simpan & Terbitkan Tugas</x-button>
                </div>
            </form>
        </x-card>
    </div>
