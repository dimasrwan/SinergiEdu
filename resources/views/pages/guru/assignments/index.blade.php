    ...
    <div class="space-y-6">
        ...
        <div class="bg-white p-4 rounded-2xl border border-slate-200 flex flex-col md:flex-row gap-4 items-center justify-between">
            <form action="{{ route('guru.assignments.index') }}" method="GET" class="w-full md:w-1/3 relative">
                ...
                <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari judul tugas..." class="block w-full pl-10 pr-3 py-2 border border-slate-300 rounded-lg leading-5 bg-white placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-accent focus:border-accent sm:text-sm transition">
            </form>
            @if(request('search'))
                    ...
                    <tr class="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center">
                            <div class="flex flex-col items-center gap-1">
                                <span class="inline-flex items-center justify-center h-8 w-8 rounded-lg bg-blue-50 text-blue-700 font-bold text-xs border border-blue-200" title="{{ $assignment->submissions_count }} Siswa Mengumpulkan">
