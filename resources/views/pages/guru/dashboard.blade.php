    ...
    <div class="w-full space-y-8">
        ...
        <div class="bg-primary rounded-3xl p-8 text-white shadow-lg shadow-primary/20 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <p class="text-blue-100 text-sm max-w-xl">Anda memiliki 3 tugas siswa yang belum dinilai hari ini. Mari mulai kegiatan mengajar dan pantau perkembangan siswa Anda.</p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <x-card padding="md" class="border-l-4 border-l-success flex items-start gap-4">
                ...
                <div>
                    <h3 class="text-2xl font-bold text-slate-900">128</h3>
            ...
            <div class="lg:col-span-2 space-y-8">
                ...
                <section>
                    <div class="flex items-center justify-between mb-4">
                        <h2 class="text-lg font-bold text-slate-900">Kelas Saya Hari Ini</h2>
                        <a href="{{ route('guru.classes.index') }}" class="text-sm font-medium text-accent hover:text-accent-hover">Lihat Semua</a>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <!-- Class Card 1 -->
                        <div class="bg-white border border-slate-200 rounded-2xl p-5 hover:border-accent transition group cursor-pointer relative overflow-hidden">
                            <div class="absolute top-0 right-0 w-2 h-full bg-accent opacity-0 group-hover:opacity-100 transition"></div>
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    <h3 class="font-bold text-slate-900 text-lg">XI IPA 1</h3>
                                    <p class="text-xs text-slate-500">Matematika Peminatan</p>
                                </div>
                                <span class="bg-blue-50 text-primary text-xs font-bold px-2.5 py-1 rounded-lg">07:30 - 09:00</span>
                            </div>
                            <div class="flex items-center justify-between border-t border-slate-100 pt-4 mt-2">
                                ...
                                <a href="#" class="text-xs font-semibold text-accent hover:underline">Masuk Kelas &rarr;</a>
                            </div>
                        </div>
                        ...
                        <div class="bg-white border border-slate-200 rounded-2xl p-5 hover:border-accent transition group cursor-pointer relative overflow-hidden">
                            ...
                            <div class="flex justify-between items-start mb-4">
                                <div>
                                    <h3 class="font-bold text-slate-900 text-lg">XI IPA 3</h3>
                                    <p class="text-xs text-slate-500">Matematika Peminatan</p>
                                </div>
                                <span class="bg-slate-100 text-slate-600 text-xs font-bold px-2.5 py-1 rounded-lg">10:15 - 11:45</span>
                            </div>
                            <div class="flex items-center justify-between border-t border-slate-100 pt-4 mt-2">
                                <div class="flex items-center gap-2 text-sm text-slate-600">
                                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z"/></svg>
                    ...
                    <div class="bg-white border border-slate-200 rounded-2xl overflow-hidden">
                        ...
                        <div class="p-4 border-b border-slate-100 flex items-center justify-between hover:bg-slate-50 transition">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 class="font-semibold text-slate-900 text-sm">Tugas Integral Substitusi</h4>
                                    <p class="text-xs text-slate-500 mt-0.5">XI IPA 1 • 12 Pengumpulan Baru</p>
                                </div>
                            </div>
                            <x-button variant="secondary" class="!py-1.5 !px-3 !text-xs">Nilai Sekarang</x-button>
                        </div>
                        <!-- Submission Item 2 -->
                        <div class="p-4 flex items-center justify-between hover:bg-slate-50 transition">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h4 class="font-semibold text-slate-900 text-sm">Latihan Matriks Ordo 3x3</h4>
                                    <p class="text-xs text-slate-500 mt-0.5">XI IPA 3 • 5 Pengumpulan Baru</p>
                                </div>
                            </div>
                            <x-button variant="secondary" class="!py-1.5 !px-3 !text-xs">Nilai Sekarang</x-button>
                        </div>
            ...
            <div class="col-span-1">
                <div class="bg-white border border-slate-200 rounded-2xl p-6 h-full">
                    ...
                    <div class="relative pl-6 space-y-6 before:absolute before:inset-0 before:ml-2.5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-slate-200 before:to-transparent">
                        ...
                        <div class="relative">
                            <div class="absolute left-[-33px] bg-white p-1 rounded-full">
                                <div class="h-3 w-3 bg-accent rounded-full ring-4 ring-sky-50"></div>
                            </div>
                            <div>
                                <p class="text-xs text-slate-500 mb-1">Hari ini, 08:30</p>
                                <p class="text-sm font-medium text-slate-900">Mempublikasikan tugas baru</p>
                                <p class="text-xs text-slate-500 mt-1">"Tugas Integral Substitusi" untuk kelas XI IPA 1.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            <div class="absolute left-[-33px] bg-white p-1 rounded-full">
                                <div class="h-3 w-3 bg-primary rounded-full ring-4 ring-blue-50"></div>
                            </div>
                            <div>
                                <p class="text-xs text-slate-500 mb-1">Kemarin, 14:15</p>
                                <p class="text-sm font-medium text-slate-900">Selesai menilai tugas</p>
                                <p class="text-xs text-slate-500 mt-1">Menilai 32 tugas "Fungsi Komposisi" XI IPA 3.</p>
                            </div>
                        </div>
                        ...
                        <div class="relative">
                            <div class="absolute left-[-33px] bg-white p-1 rounded-full">
                                <div class="h-3 w-3 bg-success rounded-full ring-4 ring-green-50"></div>
                            </div>
                            <div>
                                <p class="text-xs text-slate-500 mb-1">Selasa, 09:00</p>
                                <p class="text-sm font-medium text-slate-900">Mengunggah materi</p>
                                <p class="text-xs text-slate-500 mt-1">Modul "Pengantar Integral" berhasil diunggah.</p>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 text-center border-t border-slate-100 pt-4">
                        <a href="#" class="text-xs font-semibold text-slate-500 hover:text-accent transition">Lihat Log Aktivitas Lengkap</a>
                    </div>
                </div>
            </div>
        </div>
