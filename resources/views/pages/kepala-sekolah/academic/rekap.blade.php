<x-layouts.app>
    ...
    <div class="space-y-6">
        <x-page-header title="Rekapitulasi Nilai" description="Rekap rata-rata nilai siswa berdasarkan semester, kelas, dan mata pelajaran.">
            <x-slot:actions>
                <a href="{{ route('kepala-sekolah.reports.export-rekap-excel') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 text-white rounded-xl text-sm font-semibold hover:bg-emerald-700 transition-colors">
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="bg-slate-50 border-b border-slate-200">
                            <th class="py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">No</th>
                            <th class="py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Nama Siswa</th>
                            <th class="py-3 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">NISN</th>
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse($rows as $row)
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="py-3 px-4 text-slate-600 text-sm">{{ $row['nisn'] }}</td>
