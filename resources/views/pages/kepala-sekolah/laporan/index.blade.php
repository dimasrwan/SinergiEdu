<x-layouts.app>
    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <a href="{{ route('kepala-sekolah.reports.weekly') }}" class="p-5 bg-white border border-slate-200 rounded-2xl hover:border-primary hover:shadow-md transition group">
            ...
            <a href="{{ route('kepala-sekolah.reports.monthly') }}" class="p-5 bg-white border border-slate-200 rounded-2xl hover:border-primary hover:shadow-md transition group">
            ...
            <a href="{{ route('kepala-sekolah.reports.semester') }}" class="p-5 bg-white border border-slate-200 rounded-2xl hover:border-primary hover:shadow-md transition group">
                <div class="h-11 w-11 rounded-xl bg-violet-50 text-violet-600 flex items-center justify-center mb-4 group-hover:bg-violet-100 transition">
            ...
            <a href="{{ route('kepala-sekolah.reports.export-rekap-excel') }}" class="p-5 bg-white border border-slate-200 rounded-2xl hover:border-emerald-500 hover:shadow-md transition group">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        @forelse($rows as $row)
                            <tr class="hover:bg-slate-50">
                                ...
                                <td class="py-3 px-4 text-slate-600 text-sm">{{ $row['class_name'] }}</td>
