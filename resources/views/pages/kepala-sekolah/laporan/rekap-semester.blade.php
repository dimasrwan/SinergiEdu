    ...
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div class="flex gap-3">
                <a href="{{ route('kepala-sekolah.reports.export-semester-pdf') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-red-600 text-white rounded-xl text-sm font-semibold hover:bg-red-700 transition-colors">
        ...
        <div class="bg-primary rounded-3xl p-8 text-white shadow-xl shadow-primary/20 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    ...
                    <h3 class="text-4xl font-bold">{{ $schoolAvgGrade }}</h3>
                </div>
                <div class="grid grid-cols-2 lg:grid-cols-5 gap-4">
                    ...
                    @foreach($components as $component)
                        <div class="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-3 text-center">
                            <p class="text-xs text-indigo-200 font-semibold uppercase tracking-wider">{{ $component['label'] }}</p>
