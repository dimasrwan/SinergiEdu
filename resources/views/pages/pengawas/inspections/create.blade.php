            ...
            <form method="POST" action="{{ route('pengawas.inspections.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <x-select name="school_id" placeholder="Pilih Sekolah" :selected="old('school_id')" :options="$schools->map(fn($s) => ['value' => $s->id, 'label' => $s->name])->toArray()" />
                        @error('school_id')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <x-date-picker name="inspection_date" value="{{ old('inspection_date') }}" required />
                    ...
                    <div>
                        ...
                        <x-select name="status" selected="{{ old('status', 'pending') }}">
