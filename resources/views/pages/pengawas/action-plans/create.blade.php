    ...
    <div class="w-full">
        ...
        <form action="{{ route('pengawas.action-plans.store') }}" method="POST"
                ...
                <div>
                    ...
                    <select id="academic_year_id" name="academic_year_id"
                        ...
                        @foreach($academicYears as $year)
                            <option value="{{ $year->id }}" @selected(old('academic_year_id') == $year->id)>{{ $year->name }}
                            </option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="flex items-center gap-3 pt-2">
                <button type="submit"
                    class="inline-flex items-center justify-center px-5 py-2.5 text-sm font-semibold text-white bg-cyan-600 hover:bg-cyan-700 rounded-xl transition shadow-sm">
                    Simpan Rencana Aksi
                </button>
                <a href="{{ route('pengawas.action-plans.index') }}"
