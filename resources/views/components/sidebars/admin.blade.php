...
<!-- PENGGUNA -->
<li class="mt-4 mb-1">
    <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider px-4">Pengguna</span>
</li>
...
<!-- AKADEMIK -->
<li class="mt-4 mb-1">
    <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider px-4">Akademik</span>
</li>
<x-sidebar-link href="{{ route('admin.classes.index') }}" :active="request()->routeIs('admin.classes.*')">
    <x-slot:icon>
        <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M12 21v-8.25M15.75 21v-8.25M8.25 21v-8.25M3 9l9-6 9 6m-1.5 12V10.332A48.36 48.36 0 0012 9.75c-2.68 0-5.302.2-7.854.582V21M3 21h18M12 6.75h.008v.008H12V6.75z" /></svg>
    </x-slot:icon>
    Kelas
</x-sidebar-link>
...
<!-- SISTEM -->
<li class="mt-4 mb-1">
    <span class="text-[10px] font-bold text-slate-400 uppercase tracking-wider px-4">Sistem</span>
</li>
<x-sidebar-link href="#" :active="false">
    <x-slot:icon>
