...
<div class="px-2 pb-2">
    <div class="text-xs font-semibold leading-6 text-slate-400 px-2 mb-2">PLATFORM</div>
...
<div class="px-2 mt-4">
    <div class="text-[10px] font-bold text-slate-400 uppercase tracking-wider px-3 mb-2">TENANTS</div>
    <ul role="list" class="space-y-1">
        <li>
