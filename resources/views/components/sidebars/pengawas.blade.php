        ...
        <x-sidebar-link href="{{ route('pengawas.students.index') }}" :active="request()->routeIs('pengawas.students.*')">
            <x-slot:icon>
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M18 18.72a9.005 9.005 0 0 0-3.096-1.51 4.5 4.5 0 0 0-5.808 0 9.005 9.005 0 0 0-3.096 1.51M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 2.25c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10Z"/></svg>
            </x-slot:icon>
            Monitoring Siswa
        </x-sidebar-link>
        ...
        <x-sidebar-link href="{{ route('pengawas.action-plans.index') }}" :active="request()->routeIs('pengawas.action-plans.*')">
            <x-slot:icon>
