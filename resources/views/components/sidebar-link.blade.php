...
$classes = ($active ?? false)
            ...
            : 'flex items-center gap-3 px-3 py-2.5 min-h-[36px] text-[13px] font-medium text-slate-500 hover:bg-slate-50 hover:text-slate-900 rounded-lg transition duration-150 group leading-tight';
@endphp
